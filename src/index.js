...
var base = Rebase.createClass({
  apiKey: "AIzaSyCWGyySAeW_L9cE81xCmxJYizSaToYG25Y",
//  authDomain: "final-5185e.firebaseapp.com",
      ...
      return (
        <div className="col-sm-12">
          <Gmaps width={'100%'}
            ...
            lat={'41.8929482'}
            lng={'-87.6248932'}
            loadingMessage={'Theatres list soon...'}
            params={{v: '3.exp', key: 'AIzaSyB3p_xQIXsFMDGLYNEiVkgW5fsVSUOd01c'}}>
            {theatres.map(function(location) {
            return <Marker lat={location.lat} lng={location.long}
              />
            })}
        </Gmaps>
        </div>
